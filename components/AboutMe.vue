<template>
    <div class="">
        ...
        <div class="py-10 pb-12 ">
            ...
            <div class="flex justify-center px-28 scale-[.97] hover:scale-105 transition ease-in-out delay-50 duration-300">
                <div class="flex mx-auto">
                    <img class="w-full object-cover rounded-l-xl" src="/assets/pic/rj-profilepic.jpeg" alt="Picture of Reza Jaber">

                    <div class="px-6 py-4 bg-[#f3f4f6] dark:bg-[#0e131f] rounded-r-xl shadow-lg">
                        <h1 class="font-heading font-semibold text-xl text-gray-800 dark:text-gray-100">Reza Jaber</h1>
