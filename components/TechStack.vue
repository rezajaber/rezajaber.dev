    ...
    <div>
        <div>
            <div class="flex items-center justify-between mt-5 px-6">
                    <span class="w-24 border-b border-black border-[1.5px] dark:border-black lg:w-2/4"></span>
                    <h2 class="font-heading font-semibold text-md text-black text-center uppercase dark:text-black">Tech Stacks</h2>
                    <span class="w-24 border-b border-black border-[1.5px] bdark:border-black lg:w-2/4"></span>
            </div>
